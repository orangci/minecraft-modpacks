...
- [juniper-s10](./juniper-s10): The Nix configuration which uses this modpack is [here](https://git.orangc.net/c/dots/src/branch/master/modules/services/gaming/minecraft/servers/juniper/season-10.nix). Completely server-side excepting the modflared mod, which is required on the client.
- [juniper-s11](./juniper-s11): The Nix configuration which uses this modpack is [here](https://git.orangc.net/c/dots/src/branch/master/modules/services/gaming/minecraft/servers/juniper/season-11.nix). This is a modded pack for both client and server.
